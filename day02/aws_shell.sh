...
main() {
    ...
    SUBNET_ID="subnet-00ef3151d1d14dcbf"
    SECURITY_GROUP_IDS="sg-06fd079a7684918b3"  # Add your security group IDs separated by space
    INSTANCE_NAME="shell-scripting-for-devops"
